...
u'C.3.6. Tesis de doctorado', u'C.4. Informacion adicional',
...
11: [('B. INFORMACIÓN DE LA BECA', '-')],
16: [('C. ESTUDIOS REALIZADOS', '-'), ('C.1. LICENCIATURA', '~')],
25: [('C.2. MAESTRÍA', '~')],
33: [('C.3. DOCTORADO', '~')],
39: [('E. COMENTARIOS DE LA COMISIÓN', '-')],
}
